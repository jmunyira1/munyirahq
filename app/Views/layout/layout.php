...
<head>
    ...
    <title>MunyiraHQ | <?= $pageTitle = $this->renderSection('title'); ?>
    </title>
    ...
    <meta name="title" content="MunyiraHq" />
    <meta name="author" content="Munyira" />
    <meta
        name="description"
        content="Munyira"
    />
    ...
    <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
        ...
        <div class="sidebar-brand">
            ...
            <a href="/index.html" class="brand-link">
                <!--begin::Brand Icon-->
                <i class="bi bi-globe brand-image opacity-75 me-2 fs-4"></i>
                <!--end::Brand Icon-->

                <!--begin::Brand Text-->
                <span class="brand-text fw-light">MunyiraHQ</span>
                <!--end::Brand Text-->
            </a>
            <!--end::Brand Link-->
        </div>
